...
class PrescriptionController extends Controller
{
    public function prescription(Request $request){
        ...
        $Investigation= DB::select("SELECT RI.Investigation,I.Instruction,I.PositiveNegativeStatus, I.OtherInvestigation, I.CreateDate
        ...
        $Treatment= DB::select("SELECT T.Frequency, T.DrugDurationValue, T.OtherDrug, T.SpecialInstruction, T.DrugDose, T.Hourly, Dr.DrugCode, Dr.Description, Ins.InstructionInBangla, T.CreateDate
        ...
        return response()->json([
            ...
            'TBSymptom'=>$TBSymptom,
            'TBEFinding'=>$TBEFinding,
            'TBEPastEvidence'=>$TBEPastEvidence,
            'TBPast'=>$TBPast,
